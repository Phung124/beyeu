...
<div class="card shadow mb-5 bg-white rounded">
    ...
    <div class="card-body">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <textarea style=" width: 435px;     height: 157px;"name="Txtnoidung"  rows="5" placeholder="Bạn đang nghĩ gì ?...." class="form-control"></textarea>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <select name="chude"  class="form-control-sm form-control">
                        ...
                        <option value="2">Bầu</option>
                        <option value="3">Cho con bú</option>
